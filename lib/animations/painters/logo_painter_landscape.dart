...
class LogoPainterLandscape extends CustomPainter {
  ...
  LogoPainterLandscape(this._lineOnefraction, this._lineTwofraction,
      this._blueCirclefraction, this._greenBarfraction) {
    _paint = Paint()
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawLine(
      const Offset(25.0, 100.0),
      const Offset(25.0, 300.0),
      _paint,
    );
    canvas.drawLine(
    ...
    var topCircle = const Offset(180.0, 60.0);
    _paint.style = PaintingStyle.fill;
    canvas.drawCircle(topCircle, _blueCirclefraction * 40.0, _paint);

    _paint.color = const Color(0xffe5453f);
    _paint.style = PaintingStyle.fill;
    var circlerect = const Offset(225, 150.0) & const Size(130.0, 130.0);
    canvas.drawArc(
        circlerect, -pi / 3, pi * 3 * _blueCirclefraction, false, _paint);

    var yellowrect =
        Rect.fromLTWH(365, 100.0, 80.0, _blueCirclefraction * 200.0);
    ...
    var greencenter = const Offset(500, 90.0);
    _paint.style = PaintingStyle.fill;
