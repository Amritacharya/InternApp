...
import 'package:intern_app/animations/painters/logo_painter_landscape.dart';

class LogoAnimatorLandscape extends StatefulWidget {
  const LogoAnimatorLandscape({Key? key}) : super(key: key);

  @override
  _LogoAnimatorLandscapeState createState() => _LogoAnimatorLandscapeState();
}

class _LogoAnimatorLandscapeState extends State<LogoAnimatorLandscape>
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: CustomPaint(
          painter: LogoPainterLandscape(_lineOnefraction, _lineTwofraction,
